...
rm -rf "$WT"/{index.html,app.js,bench.js,data.js,race.js,gif.js,learn.js,replayhouse.js,engine,coi-serviceworker.min.js}
cp web/index.html web/app.js web/bench.js web/data.js web/race.js web/gif.js web/replayhouse.js "$WT/"
